Under mappen "data" ligger alle csv filene vi har brukt i denne oppgaven. Under undergruppen "old_data" ligger eldre csv-er og json-filer som ble brukt for å forstå oss på metoden. 
